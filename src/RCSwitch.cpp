...
#else
static PROGMEM const RCSwitch::Protocol proto[] = {
#endif
...
void RCSwitch::getReceivedProtocolData(Protocol &protocol)
{
  memcpy_P(&protocol, &proto[nReceivedProtocol - 1], sizeof(Protocol));
}
